        ...
        if choice =="T" or choice == "t":
            ...
            if choice1 == "y" or choice1 == "Y":
                if gifts[x] in inventory:
                    ...
                    print("You have no ",needs[x]," to give. Try exlporing some more worlds!")
